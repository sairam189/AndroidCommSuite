...
from acts.test_utils.bt.import Audacity_test
...
class Audacity_Integration_Test(BluetoothBaseTest):
    default_timeout = 20
    iterations = 5
    ...
    def test_Wifi_ap(self):
        ...
        self.log.info("Channel {}.".format(self.channel))
    ...
    def test_connect_disconnect_headset(self):
        ...
        for n in range(self.iterations):
            ...
            if not connect_dev_to_headset(
                    self.log, self.dev, self.headset_to_connect,
